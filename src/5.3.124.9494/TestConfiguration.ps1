...
$argList = @($DeployerBinPath, $ServiceFabricPowershellModulePath, $ClusterConfigFilePath, $MicrosoftServiceFabricCabFileAbsolutePath)
Powershell -Command {
    param (
        [Parameter(Mandatory=$true)]
    ...
    Try 
    {
        Test-ServiceFabricConfiguration -ClusterConfigurationFilePath $ClusterConfigFilePath -FabricRuntimePackagePath $MicrosoftServiceFabricCabFileAbsolutePath
    }
    Catch
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCF4GiNgJBqyA97LE6a4Pkyrt
# gaCgghWDMIIEwzCCA6ugAwIBAgITMwAAAKxjFufjRlWzHAAAAAAArDANBgkqhkiG
...
# kta5r7pGje5gOSY72tyJS5vwITBaBgorBgEEAYI3AgEMMUwwSqAsgCoAVABlAHMA
# dABDAG8AbgBmAGkAZwB1AHIAYQB0AGkAbwBuAC4AcABzADGhGoAYaHR0cDovL3d3
# dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAIjTm4Ndq1qScgGNhpTL
# Uyk6ygi51dmAZjs5Ln8g8G2qstGcmnjGRcSD5lbkZUGuKFj/qvmK/RDxGyvSuSKF
# iCB+qSKWZag0BwjvXMTi209DujP2KXLYYOGDPGRX1VILlR0/E7BTzvIEbXISOQl/
# Sj2ICMF1QxZTxgionndAK8ROX+eYYsP3d2YBWC4UT/eal7ndMHDwxK75qyBrxaiC
# I/a5/7d+oa5t9OO+BvdW3N4S2HneQmbSD4qDowFLQhQMUrff1KRFf92tgfr3jjc3
# gl6eebfsrC00WIAdtAi/dM7IwIyQfzAyMAVqe2vu2JvrKI7DniBn2kdmJXfDTjjX
# Gu6hggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UEBhMC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNjA5MTYw
# MTM2MTVaMCMGCSqGSIb3DQEJBDEWBBSAHX5ZL/PuEM0Ylt6g/QbKgCGUtTANBgkq
# hkiG9w0BAQUFAASCAQA+RgzxzBkQBr6bXIx6pwg8sCi0qqm3QcMSUXOoIu6k8as/
# ncUm8rkwJQoSjHpt0Bl5DVlPtJZLizBwQ3BjulnGBHht7+0I/l64LAOewD6XiKe5
# 8aCaxbgtDFRcLHmv3MOVi0vAbG+HBjYORfvyt6VDjs4KHwVlqw2ynldAgv1pM2GE
# UR8zrxAFN/M1VvSayqykgyab3bo5TzDaYwoMROQGoPxY9BSEj5ZQ/ObLIF2Pn1vw
# cUs7uxiDC4mrrmlaRgdLWEnfoLYPu0JEE4T2hc8wu7Jd1IU9M7CYFuSCBbGq4k0X
# WW8ITWrYjohHG7Bgq6jGkR2iDh7xXt5H7t3EoUvx
