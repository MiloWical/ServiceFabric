...
$argList = @($FabricCodePath, $SystemFabricModulePath, $ExistingClusterConnectionEndpoint, $ServiceFabricPowershellModulePath, $MicrosoftServiceFabricCabFilePath, $NodeName, $NodeType, $NodeIpAddressOrFQDN, $UpgradeDomain, $FaultDomain )
Powershell -Command {
    param (
        [Parameter(Mandatory=$true)]
    ...
    Try 
    {
        ...
        Connect-ServiceFabricCluster $ExistingClusterConnectionEndpoint
        Get-ServiceFabricNode |ft
        Add-ServiceFabricNode -NodeName $NodeName -NodeType $NodeType -IpAddressOrFQDN $NodeIpAddressOrFQDN -UpgradeDomain $UpgradeDomain -FaultDomain $FaultDomain -FabricPackageSourcePath $MicrosoftServiceFabricCabFilePath -PreviewMode $true -Verbose
    }
    Catch
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCPnjRqych6nQuFYJampNJwjA
# U3GgghWCMIIEwzCCA6ugAwIBAgITMwAAAK7sP622i7kt0gAAAAAArjANBgkqhkiG
...
# 9X7+KIkCzLFNq/bc2WDo15qsQiACPVSKY1IOGiIwggTsMIID1KADAgECAhMzAAAB
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFAlJ
# Khl6v9UqCzBW+L3sPC1RS2eoMEYGCisGAQQBgjcCAQwxODA2oBiAFgBBAGQAZABO
# AG8AZABlAC4AcABzADGhGoAYaHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqG
# SIb3DQEBAQUABIIBAHbbMjwf6zkbNig/A9IMGpZX2ZgCP1OTVlej5zE79NFob/M9
# /i/vTVbk3B2RXEKmrRSQQrtqR+JYzkcat50iajkyjSKYnIaDLhOkpOs7JLoJffZk
# smpbxoMkqZvn9PCbsvkFiwCj2rBCn24Dre7cfr+RQxx6Zvx5WikJlIWqSBrrDn9c
# UtPtEcvpn6lEol4Nf8J0BUvKdNWmBXP771ishWnP/WIIuoW0PZrG6W+I76Llxb0B
# tmFeD9Ik3HSo8+SCMdIX6GMj5QGfskHOc8dOHBpFrc777WxPnWFg51xXejshnC6M
# k1s8I9R0OdiVnFSdC4anfhy71MNvuclUu3o6oUqhggIoMIICJAYJKoZIhvcNAQkG
# MYICFTCCAhECAQEwgY4wdzELMAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0
# b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3Jh
# dGlvbjEhMB8GA1UEAxMYTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENBAhMzAAAAruw/
# rbaLuS3SAAAAAACuMAkGBSsOAwIaBQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcN
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xNjA2MTgwMjM0NTdaMCMGCSqGSIb3DQEJBDEW
# BBQ9l4RDoiCUsvc5SAscKgL8C8xdTTANBgkqhkiG9w0BAQUFAASCAQC5x4otOc8d
# FQkQNiKrWsmyoT9lCG5WMOU1doWXkfM3/fhxalaHfPgiA8L33fdtQQ9l+53TgaDf
# yb19AETsTpt2CI4O0aajxLDCaASGwEz5EpfGc93j2n302nhq5wSU2dDCcCzXCBU4
# +KARjRQbseguOLvKJBrFW59HQroIwGkdhBuzB/UpVbEOKIeS1OEn7Ix9B9QYb9CB
# nQvSOOQTNQQnBHTKsmCfPQB8VxZgBXTICLTPJNqa6xYnk3BKMAbBXNx+d0NUWvbh
# li3HRBvw53NP4we7YpKtx/unm39lqQHeUiBSvbPSRRtYXcW3pYTZmFOomX5zjvxm
# HeC0xo/zQRDG
